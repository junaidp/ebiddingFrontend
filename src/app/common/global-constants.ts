export class GlobalConstants {
    ...
    public static baseUrl = "https://3218-2a0a-a540-c45b-0-5400-d679-693-3bd7.ngrok.io/api/";
...
export class BidConstant {
    public static projectStepper = 0;
    public static contractorStepper = 1;
}
